...
# All Jemdoc files
DOCS=index teaching members research service matholympiad publications software news talks contacts $(TEACHING_DOCS) $(MEMBER_DOCS) $(RESEARCH_DOCS) $(SOFTWARE_DOCS)
